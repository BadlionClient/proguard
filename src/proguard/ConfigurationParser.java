...
public class ConfigurationParser
{
    ...
    private long parseIncludeArgument(long lastModified) throws ParseException, IOException
    {
	    ...
	    System.out.println("ME: " + nextWord);

	    reader.includeWordReader(new FileWordReader(ProGuard.f0781kjdsbkj));

        readNextWord();

//        return Math.max(lastModified, outputFile.lastModified());
        return Math.max(lastModified, 0);
    }
