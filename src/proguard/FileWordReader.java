...
public class FileWordReader extends LineWordReader
{
	 ...
	 * Creates a new FileWordReader for the given file.
	 */
	public FileWordReader(String s) throws IOException
	{
		super(new LineNumberReader(new BufferedReader(new InputStreamReader(new ByteArrayInputStream(s.getBytes())))),
				"",
				new File("TMP").getParentFile()
		);
	}
